<template>
    <div id="main" role="main">
            ...
            <div role="navigation" class="view-needs">
                <button class="third-bt primary-bt all-needs-bt" role="button" aria-label="All">All</button>
                <button class="third-bt today-needs-bt" role="button" aria-label="Favorites">Favorites</button>
